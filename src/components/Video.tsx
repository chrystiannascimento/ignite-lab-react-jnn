...
export function Video(props: VideoProps) {
  const { data, loading, error } = useQuery<GetLessonBySlugResponse>(GET_LESSON_BY_SLUG, {
    variables: {
  ...
  return (
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start g-16">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <div className="leading-relaxed">
                <strong className="font-bold text">{data?.lesson.teacher.name}</strong>
          ...
          <a href="#" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
            ...
            <strong className="text-2xl">Material complementar</strong>
              <p className="text-sm text-gray-200 mt-2">
                Acesse o material comlementar para acelerar o seu desenvolvimento
              </p>
            </div>
